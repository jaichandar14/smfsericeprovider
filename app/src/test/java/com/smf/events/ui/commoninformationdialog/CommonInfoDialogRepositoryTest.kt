...
class CommonInfoDialogRepositoryTest {

    @get:Rule
    var instantExecutorRule: InstantTaskExecutorRule = InstantTaskExecutorRule()

    private lateinit var repository: CommonInfoDialogRepository
    ...
    fun setUp() {
        ...
        repository = CommonInfoDialogRepository(testApis)
    }
    ...
    @Test
    fun `for StartService, api must return StartService details with http code 200`() =
        runBlocking {
    ...
    @Test
    fun `for server error, StartService api must return with http error message`() = runBlocking {
        val expectedResponse = MockResponse()
