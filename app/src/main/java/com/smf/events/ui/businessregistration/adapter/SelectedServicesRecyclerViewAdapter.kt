...
class SelectedServicesRecyclerViewAdapter(
    private val context: Context,
    private val items: ArrayList<SelectedServices>
) : RecyclerView.Adapter<SelectedServicesRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return ViewHolder(
            LayoutInflater.from(context).inflate(R.layout.selected_service_card_view, parent, false)
        )
    }

    override fun onBindViewHolder(
        holder: SelectedServicesRecyclerViewAdapter.ViewHolder,
        position: Int
    ) {
        ...
        holder.closeBtn.setOnClickListener {
            Toast.makeText(
                context,
                "close clicked ${items[position].serviceTitle}",
                Toast.LENGTH_SHORT
            ).show()
        }
